...
class Crack:
    ...
    def start(self):
        ...
        print("]", end="")
        print(base64.b64decode(b'TWFkZSBieSB0aGUgS0lORyBLQU1JISEhISEhIQ==').decode('utf-8'))
        time.sleep(3)
        self.clear()
            ...
            while True:
                ...
                try:
                        ...
                        if response['errors'][0]['code'] == 4:
                            ...
                            if not printed:
                                start = time.time()
                                uiprint(f'Too many requests. Waiting 20 minutes before resumimg, don\'t forget to leave this open for a few days!', 'ratelimit')
                                printed = True
